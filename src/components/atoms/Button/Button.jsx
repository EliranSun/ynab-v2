...
const Button = ({
    ...
    return (
        <button
            onClick={onClick}
            disabled={isDisabled}
            className={classNames("flex justify-center rtl:flex-row-reverse items-center gap-2 min-w-12 p-3", className, {
                "opacity-50 cursor-not-allowed": isDisabled,
                "bg-blue-500 md:hover:bg-blue-700 text-white font-bold rounded": type === Types.PRIMARY,
